...
export default async function weeklyWeather() {
    ...
    const { isError: weeklyWeathetError, data: weather } = await getWeeklyWeather(lat, lon)
    if(weeklyWeathetError) return console.log('oh! a ocurrido un error trayendo el pronostico del clima')
